...
topics = [
    ...
    "PCI DSS compliance for Los Angeles retail and e-commerce businesses",
    "FTC Safeguards Rule compliance for Los Angeles auto dealers and finance companies",
    "CMMC compliance guide for Los Angeles defense contractors",
    "SOC 2 readiness for Los Angeles SaaS and technology companies",
    "CCPA and CPRA data privacy compliance for California businesses",
    "The NIST Cybersecurity Framework explained for Los Angeles small businesses",
    "FINRA and SEC IT compliance for Los Angeles investment firms",
    "What Los Angeles businesses need to qualify for cyber insurance",
    # --- Security ---
    "Why multi-factor authentication is non-negotiable for Los Angeles businesses",
    "Phishing awareness training for Los Angeles employees",
    "Dark web monitoring: is your Los Angeles company's data for sale",
    "Managed detection and response (MDR) explained for Los Angeles businesses",
    "What is a security operations center (SOC) and does your business need one",
    "A practical guide to penetration testing for Los Angeles businesses",
    "Vulnerability management: closing the security gaps attackers exploit",
    "Choosing a business password manager: a Los Angeles IT guide",
    "Securing your remote workforce: a cybersecurity checklist for Los Angeles companies",
    "Protecting your Los Angeles business from insider threats",
    "Email security beyond spam filters for Los Angeles businesses",
    "Mobile device management (MDM) for Los Angeles distributed teams",
    "Office Wi-Fi security best practices for Los Angeles businesses",
    "How to recognize and stop social engineering attacks",
    "Building an incident response plan for your Los Angeles business",
    "Security awareness training: turning employees into your first line of defense",
    # --- Cloud & infrastructure ---
    "Microsoft 365 security features most Los Angeles businesses overlook",
    "Microsoft Teams, Slack, or Zoom: collaboration tools for Los Angeles businesses",
    "Azure vs AWS: choosing a cloud platform for your Los Angeles business",
    "SharePoint and OneDrive document management for Los Angeles firms",
    "Building a hybrid cloud strategy for Los Angeles mid-size businesses",
    "Cloud vs on-premise vs hybrid: which is right for your Los Angeles business",
    "VoIP phone systems for Los Angeles businesses: a buyer's guide",
    "Network infrastructure planning for a new Los Angeles office",
    "Structured cabling and networking for Los Angeles commercial spaces",
    "Choosing business laptops and workstations for your Los Angeles team",
    "Print management and document security for Los Angeles offices",
    # --- IT operations & strategy ---
    "After Windows 10 end of life: upgrade options for Los Angeles businesses",
    "An IT onboarding and offboarding checklist for Los Angeles employers",
    "Hardware lifecycle management for Los Angeles businesses",
    "IT asset management best practices for Los Angeles companies",
    "How to reduce IT downtime at your Los Angeles business",
    "IT support for opening a second office in Los Angeles",
    "Integrating IT systems after a merger or acquisition",
    ...
    "Technology solutions for Los Angeles property management companies",
    "IT support for Los Angeles construction companies",
    "Managed IT for Los Angeles insurance agencies",
    "IT and cybersecurity for Los Angeles restaurants and hospitality",
    "IT services for Los Angeles architecture and engineering firms",
    "Cybersecurity for Los Angeles biotech and life sciences companies",
    "IT support for Los Angeles marketing and advertising agencies",
